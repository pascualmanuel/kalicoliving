...
import galleryImage1 from "../public/assets/images/gallery/gallery-1.webp";
import galleryImage2 from "../public/assets/images/gallery/gallery-2.webp";
import galleryImage3 from "../public/assets/images/gallery/gallery-3.webp";
import galleryImage4 from "../public/assets/images/gallery/gallery-4.webp";
import galleryImage5 from "../public/assets/images/gallery/gallery-5.webp";
...
const GallerySection = () => {
  ...
  useEffect(() => {
    // Preload gallery images to avoid a noticeable delay on manual navigation.
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <h2 className="text-black title text-center text-[45px] mb-10">
        Gallery
      </h2>
