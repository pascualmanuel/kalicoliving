...
const META_DESCRIPTIONS: Record<PageKey, { en: string; es: string }> = {
  home: {
    en: "Kali Coliving – Live together, grow forever. Community-focused coliving in Barcelona. Designed spaces, real connections, and a place to belong. Apply now.",
    es: "Kali Coliving – Vive juntos, crece para siempre. Coliving con comunidad en Barcelona. Espacios diseñados, conexiones reales y un lugar donde encajar. Aplica ya.",
  },
  community: {
    en: "Meet the Kali community. People who leave a mark. Live with like-minded people in Barcelona and grow through shared experiences and real connections.",
    es: "Conoce la comunidad Kali. Personas que dejan huella. Vive con gente con tus mismos valores en Barcelona y crece con experiencias compartidas y conexiones reales.",
  },
  blog: {
    en: "Kali Coliving blog – Stories, tips and inspiration about coliving, Barcelona and community life. Culture, gastronomy, entrepreneurship and local plans.",
    es: "Blog de Kali Coliving – Historias, consejos e inspiración sobre coliving, Barcelona y vida en comunidad. Cultura, gastronomía, emprendimiento y planes locales.",
  },
  landlords: {
